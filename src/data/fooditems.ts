...
Served with homemade chutney.`,
      ...
      },
      {
        ...
        description: `Expertly hand-rolled and twisted into soft, airy ribbons, these chickpea flour delights are seasoned with a hint of black pepper. Light and melt-in-your-mouth, they are traditionally served with spicy fried chillies and crunchy papaya sambharo.`,
        quantity: "",
        price: "$8.99",
      },
      {
      ...
      {
        id: 9,
        image: "../images/menu-images/Regular-Thepla.png",
        title: "Regular Thepla",
        description: `Thin, soft, and wholesome whole wheat flatbreads infused with turmeric and aromatic spices, griddled to golden perfection and traditionally enjoyed with cooling yogurt or tangy mango pickle.`,
        quantity: "",
        price: "$1.99",
      },
      {
        id: 10,
        image: "../images/menu-images/Methi-Thepla.png",
        title: "Methi Thepla",
        description: `Fragrant and tender flatbreads kneaded with fresh fenugreek leaves, sesame seeds, and warm spices, offering a perfect balance of herbal notes and savory flavors that pair beautifully with sweet chunda or masala chai.`,
        quantity: "",
        price: "$2.49",
      },
    ],
...
chutneys, onions, and flavourful spices.`,
      ...
      },
      {
        ...
        title: "Pav Bhaji with 2 Pav(Buns)",
      ...
      {
        id: 8,
        image: "../images/menu-images/Dal-Vada.png",
        title: "Dal Vada",
        description: `Crispy, golden-brown lentil fritters made from coarsely ground chana dal and spices, packed with a crunch and traditionally served with fried green chillies and sliced onions.`,
        quantity: "",
        price: "$8.99",
      },
      {
        id: 9,
        image: "../images/menu-images/Methi-Bhajiya.png",
        title: "Methi Bhajiya/Pakora",
        description: `Soft, pillowy gram flour dumplings infused with fresh fenugreek leaves and black pepper, deep-fried to perfection and served with a tangy kadhi or sweet-spicy chutney.`,
        quantity: "",
        price: "$8.99",
      },
      {
        id: 10,
        image: "../images/menu-images/Dahi-Vada.png",
        title: "Dahi Vada",
        description: `Fluffy, deep-fried lentil dumplings soaked in thick, sweetened yogurt and topped with roasted cumin powder, red chili, and a drizzle of tangy tamarind and mint chutneys.`,
        quantity: "",
        price: "$8.99",
      },
      {
        id: 11,
        image: "../images/menu-images/Pani-Puri.png",
        title: "Pani Puri",
        description: `Crispy, hollow semolina spheres filled with spiced potatoes and chickpeas, served with a signature burst of chilled, tangy mint water and sweet tamarind dates chutney.`,
        quantity: "",
        price: "$5.99",
      },
      {
        id: 12,
        image: "../images/menu-images/Sev-Puri.png",
        title: "Sev Puri",
        description: `Crisp papdis topped with diced potatoes, onions, and a trio of vibrant chutneys, finished with a generous layer of fine sev, fresh cilantro, and a hint of chaat masala.`,
        quantity: "",
        price: "$5.99",
      },
      {
        id: 13,
        image: "../images/menu-images/Dahi-Puri.png",
        title: "Dahi Puri",
        description: `A refreshing street-side classic featuring crispy puris stuffed with potatoes and sprouts, overflowing with chilled yogurt and colorful chutneys, topped with crunchy sev.`,
        quantity: "",
        price: "$5.99",
      },
    ],
...
with ketchup, mayonnaise and garlic-mint sauce.`,
      ...
      },
      {
        ...
        title: "COMBO: Any Burger+Fries+Pop",
        description: `Your choice of a juicy, flavorful burger served alongside a portion of hot, salted golden fries and a refreshing, chilled fountain drink.`,
        price: "$10.99",
        quantity: "",
      },
    ],
...
//  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        title: "Butter Chicken Naan Wrap",
  ...
  },
  {
    ...
    items: [
     ...
     //   description: ``,
      ...
      {
         id: 5,
         image: "../images/menu-images/Mango_Milkshake.png",
         title: "Mango Milkshake",
         description: `A tropical, sunshine-filled delight made with luscious mango pulp and chilled milk, blended to a silky consistency for a refreshing fruity finish.`,
         price: "$6.99",
         quantity: "",
         isSignature: true,
       },
       {
         id: 6,
         image: "../images/menu-images/Oreo_Milkshake.png",
         title: "Oreo Milkshake",
         description: `A thick, creamy shake loaded with crushed Oreo cookie chunks and vanilla bean notes, offering a delightful crunch in every sip.`,
         price: "$6.99",
         quantity: "",
         isSignature: true,
       },
       {
         id: 7,
         image: "../images/menu-images/Biscoff_Milkshake.png",
         title: "Biscoff Milkshake",
         description: `An indulgent, caramelized treat featuring the unique spiced-speculoos flavor of Biscoff cookies, blended into a thick and buttery smooth shake.`,
         price: "$6.99",
         quantity: "",
         isSignature: true,
       },
